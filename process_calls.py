...
Usage:
    python process_calls.py /path/to/input.csv /path/to/output.xlsx
"""
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python process_calls.py <input_csv> <output_xlsx>")
        sys.exit(1)
    ...
    print(f"Done. Wrote {len(summary)} agreement(s) to {output_xlsx}")
